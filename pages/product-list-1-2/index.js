...
export default function ProductList_1_2() {
  return (
    <>
      <Head>
      ...
      >
        <section className={styles["hero"]}>
          ...
          <div className={`${styles["container"]} container`}>
            <div className={styles["hero-context"]}>
              <h1 className={styles["hero-title"]}>Table & Console Mirrors</h1>
        ...
        <section className={styles["product-description-container"]}>
          <div className={`${styles["container"]} container`}>
            ...
            <h3 className={styles["description-title"]}>Table & Console Mirrors</h3>
          </div>
        </section>
        ...
        <section className={styles["product-list"]}>
          <div className={`${styles["container"]} container`}>
            ...
            <div className={styles["more-products"]}>
              ...
              <Link href="/product-list-1-1" scroll={false}>
